...
export const metadata: Metadata = {
  ...
  description: "Put any 3 providers head to head. Compare spending, claims per patient, cost per claim, risk flags, and yearly billing trends from 227M records.",
  openGraph: {
    title: "Compare Medicaid Providers Side by Side",
