    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "COVID Profiteers: Chicago",
          "description": "Chicago went from $23M to $240M in Medicaid billing during COVID. One provider went from $0 to $2.1B. See the 100 biggest pandemic billing jumps, ranked.",
          "url": "https://www.openmedicaid.org/insights/pandemic-profiteers",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/pandemic-profiteers" }
        }) }}
      />
      {/* Breadcrumb */}
