    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "Medicaid Doubled: $109B to $199B in Just 6 Years",
          "description": "Medicaid spending surged 83% from 2018 to 2023. COVID was the inflection point — 2021 alone added $30.5B. Here",
          "url": "https://www.openmedicaid.org/insights/spending-growth",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/spending-growth" }
        }) }}
      />
      {/* Breadcrumb */}
