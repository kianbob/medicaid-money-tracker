    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "108M Patients, 1 Provider: Medicaid",
          "description": "One Medicaid provider bills for 108 million beneficiaries — more than most countries",
          "url": "https://www.openmedicaid.org/insights/most-patients",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/most-patients" }
        }) }}
      />
      {/* Breadcrumb */}
