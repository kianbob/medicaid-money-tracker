...
const insightCategories: { label: string; description: string; accent: string; items: Insight[] }[] = [
  {
    ...
    items: [
      ...
      {
        slug: "impossible-volume",
        title: "Impossible Billing Volume: 50+ Claims Per Day",
        teaser: "200 providers file more than 50 claims per working day — some over 60,000. At that pace, each patient visit would last seconds.",
        stat: "60K+",
        statLabel: "claims/day",
        color: "from-red-500 to-orange-500",
        accent: "text-red-400",
        icon: "⏱️",
      },
      {
        slug: "benford-analysis",
        title: "When the Numbers Don't Add Up: Benford's Law Analysis",
        teaser: "Benford's Law predicts leading digit distribution in natural data. We tested 617K providers' claim amounts — 200 show statistically significant deviations.",
        stat: "200",
        statLabel: "flagged providers",
