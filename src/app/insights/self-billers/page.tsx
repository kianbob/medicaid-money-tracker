    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "100 Providers Billed $72B With No Outside Help",
          "description": "These 100 Medicaid providers bill $5M+ each with 95%+ self-billing ratios — $72B total, millions of claims processed entirely alone. Who are they?",
          "url": "https://www.openmedicaid.org/insights/self-billers",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/self-billers" }
        }) }}
      />
      {/* Breadcrumb */}
