...
export default function CovidVaccines() {
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      {/* Headline */}
      <div className="mb-10">
        <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-3 py-1 text-xs font-medium text-cyan-400 mb-4">
      ...
      <div className="border-t border-dark-500/50 pt-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("Who got paid the most to give COVID vaccines through Medicaid? Tribal hospitals dominate the list.")}&url=${encodeURIComponent("https://medicaidmoneytracker.com/insights/covid-vaccines")}`} target="_blank" rel="noopener noreferrer" className="text-xs text-slate-500 hover:text-blue-400 transition-colors">Share on X</a>
          </div>
        </div>
