    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "DOGE Released Medicaid Data — We Already Analyzed It",
          "description": "DOGE wants the public to find Medicaid fraud. We already analyzed all 227M records: 1,860 flagged providers, $37.4B in improper payments, 40 billing while banned.",
          "url": "https://www.openmedicaid.org/insights/doge-medicaid",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/doge-medicaid" }
        }) }}
      />
      {/* Breadcrumb */}
