    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "$14.6B Fraud Bust: 324 Charged, Billions Still Missing",
          "description": "The DOJ",
          "url": "https://www.openmedicaid.org/insights/2025-fraud-takedown",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/2025-fraud-takedown" }
        }) }}
      />
      {/* Breadcrumb */}
