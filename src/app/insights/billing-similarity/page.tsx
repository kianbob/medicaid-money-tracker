    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "67 Provider Pairs Bill in 100% Identical Patterns",
          "description": "246 pairs of flagged Medicaid providers share 95%+ billing similarity. 67 pairs are perfect 100% matches — same codes, same proportions, different NPIs.",
          "url": "https://www.openmedicaid.org/insights/billing-similarity",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/billing-similarity" }
        }) }}
      />
      {/* Breadcrumb */}
