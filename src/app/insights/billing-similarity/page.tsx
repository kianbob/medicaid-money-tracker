      ...
      <div className="border-t border-dark-500/50 pt-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("246 pairs of flagged Medicaid providers have >95% identical billing patterns. 67 pairs match at 100%. Are they the same org under different NPIs?")}&url=${encodeURIComponent("https://medicaidmoneytracker.com/insights/billing-similarity")}`} target="_blank" rel="noopener noreferrer" className="text-xs text-slate-500 hover:text-blue-400 transition-colors">Share on X</a>
          </div>
        </div>
