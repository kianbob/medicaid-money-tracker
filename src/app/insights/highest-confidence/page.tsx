    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "246 Providers Flagged by Multiple Fraud Detection Systems",
          "description": "When statistical tests, Benford",
          "url": "https://www.openmedicaid.org/insights/highest-confidence",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/highest-confidence" }
        }) }}
      />
      {/* Breadcrumb */}
