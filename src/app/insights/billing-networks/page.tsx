    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "78 of Top 100 Medicaid Billing Middlemen Are Flagged",
          "description": "The top 100 Medicaid billing intermediaries control $42.6B in payments. 78 are on our fraud watchlist. One entity bills for 5,000+ providers alone.",
          "url": "https://www.openmedicaid.org/insights/billing-networks",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/billing-networks" }
        }) }}
      />
      {/* Breadcrumb */}
