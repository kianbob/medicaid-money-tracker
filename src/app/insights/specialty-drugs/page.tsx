    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "$92,158 Per Claim: Medicaid",
          "description": "50 specialty drugs billed through Medicaid as J-codes total $3.5B+. The priciest costs $92,158 per claim. Many are billed by just 1-3 providers nationwide.",
          "url": "https://www.openmedicaid.org/insights/specialty-drugs",
          "publisher": { "@type": "Organization", "name": "OpenMedicaid", "url": "https://www.openmedicaid.org" },
          "author": { "@type": "Organization", "name": "OpenMedicaid" },
          "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.openmedicaid.org/insights/specialty-drugs" }
        }) }}
      />
      {/* Breadcrumb */}
