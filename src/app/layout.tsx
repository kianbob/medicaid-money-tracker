          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-sm">
              ...
              <div>
                ...
                <a href="https://www.opensubsidies.us" target="_blank" rel="noopener noreferrer" className="block text-slate-500 hover:text-blue-400 transition-colors">OpenSubsidies — Farm Subsidies ↗</a>
