            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-sm">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <a href="https://www.autopilotwatch.com" target="_blank" rel="noopener noreferrer" className="block text-slate-500 hover:text-blue-400 transition-colors">AutoPilotWatch ↗</a>                  <a href="https://www.shelterscope.com" target="_blank" rel="noopener noreferrer" className="block text-slate-500 hover:text-blue-400 transition-colors">ShelterScope ↗</a>
                ...
                <div className="space-y-2">
                  ...
                  <Link href="/privacy" className="block text-slate-500 hover:text-blue-400 transition-colors">Privacy Policy</Link>
