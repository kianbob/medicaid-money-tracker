      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8" aria-label="Credibility">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            { value: "9", label: "Statistical risk tests", icon: "🔬" },
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16" aria-label="Built with">
        <div className="flex flex-wrap items-center justify-center gap-3 py-6 border-t border-b border-dark-500/30">
          ...
          {[
            ...
            { label: "9 Statistical Tests", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16" aria-label="Explore more data">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            { href: "https://www.clearprices.org", title: "ClearPrices", desc: "Hospital price transparency data", domain: "clearprices.org" },
            { href: "https://www.openmedicare.us", title: "OpenMedicare", desc: "Medicare provider & drug spending data", domain: "openmedicare.us" },
            { href: "https://www.givescope.com", title: "GiveScope", desc: "Search 1.9M nonprofits", domain: "givescope.com" },
          ].map((site) => (
