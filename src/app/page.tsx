      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16" aria-labelledby="how-it-works-heading">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-dark-800 border border-dark-500/50 rounded-xl p-6 hover:border-blue-500/20 transition-all">
            <div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center mb-4">
              <svg className="w-5 h-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 7v10c0 2 1 3 3 3h10c2 0 3-1 3-3V7c0-2-1-3-3-3H7C5 4 4 5 4 7zm0 5h16M9 4v16" /></svg>
            </div>
            <p className="text-lg font-bold text-white mb-2">227M Records Analyzed</p>
            <p className="text-sm text-slate-400 leading-relaxed">Every Medicaid billing record from 2018&ndash;2024, sourced directly from HHS open data.</p>
          </div>
          <div className="bg-dark-800 border border-dark-500/50 rounded-xl p-6 hover:border-purple-500/20 transition-all">
            <div className="w-10 h-10 rounded-lg bg-purple-500/10 flex items-center justify-center mb-4">
              <svg className="w-5 h-5 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
            </div>
            <p className="text-lg font-bold text-white mb-2">13 Statistical Tests + ML</p>
            <p className="text-sm text-slate-400 leading-relaxed">Code-specific benchmarks, billing pattern analysis, and a random forest model trained on 514 confirmed fraud cases.</p>
          </div>
          <div className="bg-dark-800 border border-dark-500/50 rounded-xl p-6 hover:border-amber-500/20 transition-all">
            <div className="w-10 h-10 rounded-lg bg-amber-500/10 flex items-center justify-center mb-4">
              <svg className="w-5 h-5 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
            </div>
            <p className="text-lg font-bold text-white mb-2">Unified Risk Scoring</p>
            <p className="text-sm text-slate-400 leading-relaxed">Statistical flags and ML scores combined into clear risk tiers: Critical, High, Elevated, and ML Flag.</p>
          </div>
        </div>
      </section>
